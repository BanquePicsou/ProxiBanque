...
public class BourseController {
	...
	public String getBourseInfo(ModelMap model, String indice) {
		...
		String[][] listeIndices = { { "A", "Agilent Technologies, Inc." }, { "AA", "Alcoa Corporation" },
				{ "AAC", "AAC Holdings, Inc." }, { "AAMC", "Altisource Asset Management Corp Com" },
				{ "AAN", "Aaron's, Inc." }, { "AAP", "Advance Auto Parts Inc Advance Auto Parts Inc W/I" },
				{ "AAU", "Almaden Minerals, Ltd." }, { "AAV", "Advantage Oil & Gas Ltd Ordinary Shares" },
				{ "AB", "AllianceBernstein Holding L.P. Units" }, { "ABB", "ABB Ltd" }, { "B", "Barnes Group, Inc." },
				{ "BA", "Boeing Company (The)" }, { "BAA", "BANRO CORPORATION Ordinary Shares" },
				{ "BABA",
				...
				{ "BAM", "Brookfield Asset Management Inc." }, { "BANC", "Banc of California, Inc." },
				{ "C", "Citigroup, Inc." }, { "CAA", "CalAtlantic Group, Inc." }, { "CAB", "Cabela's Inc Class A" },
				{ "CABO", "Cable One, Inc." }, { "CACI", "CACI International, Inc. Class A" },
				{ "CAE", "CAE Inc. Ordinary Shares" }, { "CAF", "Morgan Stanley China A Share Fund Inc." },
				{ "CAG", "ConAgra Brands, Inc." }, { "CAH", "Cardinal Health, Inc." },
				{ "CAI", "CAI International, Inc." }, { "D", "Dominion Resources, Inc." },
				{ "DAC", "Danaos Corporation" }, { "DAL", "Delta Air Lines, Inc." }, { "DAN", "Dana Incorporated" },
				{ "DAR", "Darling Ingredients Inc." }, { "DATA", "Tableau Software, Inc. Class A" },
				{ "DB", "Deutsche Bank AG" }, { "DB.RT", "Deutsche Bank Aktiengesellschaft" },
				{ "DBD", "Diebold Nixdorf Incorporated" },
				{ "DBL", "DoubleLine Opportunistic Credit Fund of Beneficial Interest" }, { "E", "ENI S.p.A." },
				...
				{ "EAT", "Brinker International, Inc." }, { "EBF", "Ennis, Inc." },
				{ "EBS", "Emergent Biosolutions, Inc." }, { "EC", "Ecopetrol S.A. American Depositary Shares" },
				{ "ECA", "Encana Corporation" }, { "F", "Ford Motor Company" },
				{ "FAC", "First Acceptance Corporation" }, { "FAF", "First American Corporation (New)" },
				...
				{ "FAX", "Aberdeen Asia-Pacific Income Fund Inc" }, { "FBC", "Flagstar Bancorp, Inc." },
				{ "FBHS", "Fortune Brands Home & Security, Inc." }, { "FBK", "FB Financial Corporation" },
				{ "FBM", "Foundation Building Materials, Inc." }, { "FBP", "First BanCorp. New" } };
